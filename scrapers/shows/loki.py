...
class Loki:
    ...
    def search_loki_ez(self):
        try:
            ...
            self.loki_logger.error("LOKI unable to connect to EZTV")
            return 0
    ...
    def search_loki_ka(self):
        try:
            ...
            if r2_resp == 200 and r3_resp == 200:
                ...
                self.loki_logger.info("KA LOKI {} => \n\tstatus: {}\n\t1080p: {}\n\t720p: {}".format(self.LOKI_SEA, r3_resp, res1[0], res1[1]))
            else:
                print("KA LOKI {} => status: {}".format(self.LOKI_SEA, r3_resp))
                self.loki_logger.info("KA LOKI {} => status: {}".format(self.LOKI_SEA, r3_resp))
            return count
        except requests.exceptions.ConnectionError as e:
            print(e)
            self.loki_logger.error(e)
            return 0
